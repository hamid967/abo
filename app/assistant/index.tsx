...
export default function AssistantScreen() {
  ...
  const suggestions = isArabic ? ["كيف أتابع حالة معاملتي؟", "ما المستندات المطلوبة لإكمال الطلب؟", "كيف أفتح تذكرة دعم؟"] : ["How do I track my transaction?", "What documents are needed to complete a request?", "How do I open a support ticket?"];
  useEffect(() => {
    let mounted = true;
    if (!copiedHistoryKey) {
      setCopiedHistory([]);
