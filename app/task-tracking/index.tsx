...
export default function TaskTrackingScreen() {
  ...
  function complete(taskId: number) {
    Alert.alert("إكمال المهمة؟", "تتوقف متابعة SLA بعد الإكمال وتُحفظ العملية في سجل التدقيق.", [{ text: "إلغاء", style: "cancel" }, { text: "إكمال", onPress: () => void updateStatus.mutateAsync({ taskId, status: "completed" }).then(() => setCompletionMessage("تم إكمال المهمة وتحديث مؤشرات SLA.")).catch(() => Alert.alert("ما قدرنا نكمل المهمة", "تحقق من اتصالك وحاول مرة ثانية.")) }]);
  }
