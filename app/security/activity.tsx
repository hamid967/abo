...
export default function SecurityActivityScreen() {
  ...
  const text = isArabic ? {
    ...
    subtitle: "راجع أماكن استخدام حسابك دون عرض بيانات حساسة.",
    devices: "الأجهزة المتصلة",
    alerts: "تنبيهات الدخول",
    noDevices: "لا توجد أجهزة مسجلة بعد.",
    noAlerts: "لا توجد تنبيهات أمنية.",
    signIn: "سجّل الدخول لعرض نشاط حسابك.",
    loading: "جارٍ تحميل سجل النشاط…",
    error: "تعذر تحميل سجل النشاط. حاول مرة أخرى.",
    lastSeen: "آخر نشاط",
    firstSeen: "أول تسجيل",
    unusual: "تم رصد دخول غير معتاد",
    securityNote: "نعرض معلومات مختصرة فقط. لا تُعرض بصمات الأجهزة أو عناوين الشبكة.",
  } : {
