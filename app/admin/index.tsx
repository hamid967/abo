...
export default function AdminDashboardScreen() {
  ...
  return <ScreenContainer edges={["top", "bottom", "left", "right"]}><View style={styles.container}>
    ...
    <Pressable onPress={() => router.push("/admin/mobile-releases" as never)} style={styles.automationLink}><Ionicons name="phone-portrait-outline" size={18} color="#0B5D45" /><View style={styles.automationCopy}><Text style={styles.automationTitle}>إصدارات تطبيق الجوال</Text><Text style={styles.automationBody}>حالة البناء وروابط APK وIPA الموثقة بعد اكتمال الإصدار.</Text></View><Ionicons name="chevron-back" size={18} color="#0B5D45" /></Pressable>
