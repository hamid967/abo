...
export function SlaWeeklyTrendChart({ trend }: { trend: SlaWeeklyTrend }) {
  ...
  return <View accessibilityLabel={`اتجاه الأداء الأسبوعي: معدل الإنجاز ${trend.weeklyRate}%، مقارنة بالأسبوع السابق ${trend.previousWeekRate}%، ${comparisonCopy}`} style={styles.card}>
...
const styles = StyleSheet.create({ card: { backgroundColor: "#FFFFFF", borderColor: "#DFE9E1", borderRadius: 20, borderWidth: 1, marginTop: 12, padding: 15 }, header: { alignItems: "center", flexDirection: "row-reverse", justifyContent: "space-between" }, copy: { alignItems: "flex-end", flex: 1 }, title: { color: "#17382F", fontSize: 15, fontWeight: "800", textAlign: "right", writingDirection: "rtl" }, subtitle: { color: "#6B7C73", fontSize: 11, marginTop: 4, textAlign: "right", writingDirection: "rtl" }, rate: { alignItems: "flex-start", marginLeft: 12 }, rateValue: { color: "#0B5D45", fontSize: 22, fontWeight: "800" }, rateLabel: { color: "#6B7C73", fontSize: 10, fontWeight: "700", writingDirection: "rtl" }, trend: { alignItems: "center", flexDirection: "row-reverse", justifyContent: "flex-end", marginTop: 12 }, trendText: { fontSize: 11, fontWeight: "800", marginRight: 4, writingDirection: "rtl" }, completedText: { color: "#74857C", fontSize: 10, writingDirection: "rtl" }, comparison: { alignItems: "center", backgroundColor: "#F7FAF8", borderRadius: 14, flexDirection: "row-reverse", justifyContent: "space-between", marginTop: 12, padding: 10 }, comparisonBlock: { alignItems: "center", flex: 1 }, comparisonLabel: { color: "#6B7C73", fontSize: 10, fontWeight: "700", writingDirection: "rtl" }, comparisonValue: { color: "#17382F", fontSize: 17, fontWeight: "800", marginTop: 3 }, comparisonMeta: { color: "#819189", fontSize: 9, marginTop: 2, writingDirection: "rtl" }, comparisonDelta: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E2EAE4", borderRadius: 10, borderWidth: 1, flexDirection: "row-reverse", gap: 3, paddingHorizontal: 7, paddingVertical: 5 }, comparisonDeltaText: { fontSize: 9, fontWeight: "800", writingDirection: "rtl" }, chart: { marginTop: 8 }, labels: { flexDirection: "row-reverse", justifyContent: "space-between", paddingHorizontal: 8 }, label: { alignItems: "center" }, day: { color: "#52685C", fontSize: 10, fontWeight: "800", writingDirection: "rtl" }, value: { color: "#86968D", fontSize: 9, marginTop: 2 } });
